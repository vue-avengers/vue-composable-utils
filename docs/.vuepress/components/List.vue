<template>
  <div>
    ...
    <button class="btn fourth" @click="reduce((total, next) => {return total + next})">Sum list</button>
    ...
    <button class="btn fourth" @click="reduce((t, n) => {t.push(n * 2); return t})">Map List</button>
